...
public class StudentCardController {
    ...
    public void updateCard(Student student) {
        ...
        String courseDisplay = (student.getEnrollmentDate() == null) ? "N/A" : student.getCourseDisplay();
        if ("Graduated".equals(courseDisplay)) {
            courseGroupLabel.setText("Graduated");
        } else {
            String groupStr = (student.getGroup() <= 0) ? "N/A" : String.valueOf(student.getGroup());
            courseGroupLabel.setText("Course " + courseDisplay + " | Group " + groupStr);
        }
